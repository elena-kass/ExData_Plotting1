### plot4.R will recreate the first plot given by the instructors.
...
##Create plot in first row, first column
plot(df_sub$datetime, df_sub$Global_active_power, type="l", 
     xlab = "", ylab="Global Active Power")

##Create plot in first row, second column
plot(df_sub$datetime, df_sub$Voltage, type="l", 
     xlab = "datetime", ylab="Voltage")

##Create plot in second row, first column
...
## Create plot in second row, second column
